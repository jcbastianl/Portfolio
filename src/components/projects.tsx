...
export function Projects() {
  ...
  const projects = [
    {
      id: 1,
      title: "Visor de Siniestralidad",
      description:
        "Plataforma de análisis y visualización de datos diseñada para gestionar métricas de siniestralidad. Arquitectura monolítica con procesamiento rápido de datos relacionales.",
      ...
      <div className="max-w-7xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {projects.map((project, index) => (
            <div
              key={project.id}
              className={`group bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl hover:border-gray-900 transition-all duration-500 hover:-translate-y-2 transform flex flex-col ${
                isVisible
